...
<head>
    ...
    <title>Riri_chatroom</title>
    <style>
        body{
            background:url("asserts/img/xihu.png") no-repeat center center fixed;
...
<script type="text/javascript">
        ...
        if (undefined != msg.names) {
            $.each(msg.names, function (key, value) {
                var htmlstr = '<li>'
                        ...
                        + '<label for="' + key + '"></label>'
                        + '</div>'
                        + '<div class="liLeft"><img src="asserts/img/natuo4.JPG"/></div>'
                        + '<div class="liRight">'
    ...
    function send() {
        ...
        $("#dope").val("");
            ...
            //发送消息
            var htmlstr = '<li><div class="answerHead"><img src="asserts/img/natuo3.JPG"></div><div class="answers">'
    ...
    function setMessageInnerHTML(innerHTML) {
            var msg = '<li>'
                    + '<div class="nesHead">'
                    + '<img src="asserts/img/natuo3.JPG">'
                    + ' </div>'
                    + '<div class="news">'
                    + innerHTML
                    + '</div>'
